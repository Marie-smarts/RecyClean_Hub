...
urlpatterns = [
    path('dashboard/', views.dashboard_view, name='recycler_dashboard'),
    ...
    path('centers/map/', views.centers_map_view, name='centers_map'),
    path('api/nearby-hosts/', views.nearby_hosts_api, name='nearby_hosts_api'),
